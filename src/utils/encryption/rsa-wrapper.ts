...
class RSAPrivateWrapper {
  ...
  public initLoadServerKeys(basePath: string): void {
    this.serverPub = fs.readFileSync(path.resolve(basePath, 'keys', 'server.public.pem'));
    this.serverPrivate = fs.readFileSync(path.resolve(basePath, 'keys', 'server.private.pem'));
    this.clientPub = fs.readFileSync(path.resolve(basePath, 'keys', 'client.public.pem'));
  }
  ...
  public serverExampleEncrypt(): void {
