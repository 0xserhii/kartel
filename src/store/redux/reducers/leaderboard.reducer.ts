...
export default function leaderboardReducer(state = initialState, action): ILeaderboardState {
    switch (action.type) {
        case ELeaderboardSocketAction.GET_LEADERBOARD_HISTORY:
            return { ...state, leaderboardHistory: action.payload as TLeaderboardHistory };
