...
export const ENABLE_MAINTENANCE_ONSTART: boolean = process.env.ENABLE_MAINTENANCE_ONSTART === 'true';
export const ENABLE_LOGIN_ONSTART: boolean = process.env.ENABLE_LOGIN_ONSTART === 'true';
...
export const SECURITY_CRYPTO_ENC_KEY: string = process.env.SECURITY_CRYPTO_ENC_KEY;
export const SECURITY_CRYPTO_SEC_KEY: string = process.env.SECURITY_CRYPTO_SEC_KEY;
...
// Blockchain configs
export const BLOCKCHAIN_HTTPPROVIDER_API: string = process.env.BLOCKCHAIN_HTTPPROVIDER_API;
export const BLOCKCHAIN_RPC_ENDPOINT: string = process.env.BLOCKCHAIN_RPC_ENDPOINT;
