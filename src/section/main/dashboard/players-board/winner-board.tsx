...
export default function WinnerBoard({ winners }: { winners: any }) {
    return (
        <div className="w-full flex flex-col">
            <p className="text-gray300 font-semibold text-xl p-3">Top Winners</p>
            <ScrollArea className="w-full bg-dark bg-opacity-80 h-88 border-purple-0.5 border shadow-purple-0.5 drop-shadow-sm rounded-lg overflow-x-auto">
